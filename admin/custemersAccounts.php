...
// استعلام لاسترجاع بيانات الحسابات للكستمرز
$sql = "SELECT id, username, email, is_active FROM users WHERE user_type = 'customer'";
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($customer['is_active'] == 1): ?>
                            <button class="btn btn-success status-button" onclick="toggleStatus(<?php echo $customer['id']; ?>, 1)">Active</button>
                        <?php else: ?>
                            <button class="btn btn-danger status-button" onclick="toggleStatus(<?php echo $customer['id']; ?>, 0)">Disabled</button>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
